...
import {
  ...
  type SyncConfigurationCollection,
  type FileStoreInterface,
...
interface PullFileStep {
  readonly type: 'pullFile'
  readonly method: string
  readonly route: string
  readonly requestBody: EmptyRequestBody | JsonRequestBody | FileRequestBody
  readonly queryParameters: QueryParameters
  readonly fileUri: ReadonlyArray<Directory | string>
}
