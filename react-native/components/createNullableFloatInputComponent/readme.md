# `react-native-app-helpers/createNullableFloatInputComponent`
...
```tsx
import { createNullableFloatInputComponent } from "react-native-app-helpers";

const ExampleInput = createNullableFloatInputComponent(
    {
