# `react-native-app-helpers/createVerticalSplitButtonComponent`
...
```tsx
import { createVerticalSplitButtonComponent } from "react-native-app-helpers";

type ExampleType = `exampleTypeA` | `exampleTypeB` | `exampleTypeC`;
type ExampleValue = `a` | `b` | `c`;

const ExampleSplitButton = createVerticalSplitButtonComponent<ExampleType, ExampleValue>({
