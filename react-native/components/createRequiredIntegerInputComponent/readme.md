# `react-native-app-helpers/createRequiredIntegerInputComponent`
...
```tsx
import { createRequiredIntegerInputComponent } from "react-native-app-helpers";

const ExampleInput = createRequiredIntegerInputComponent(
    {
