# `react-native-app-helpers/createRequiredFloatInputComponent`
...
```tsx
import { createRequiredFloatInputComponent } from "react-native-app-helpers";

const ExampleInput = createRequiredFloatInputComponent(
    {
