# `react-native-app-helpers/createNullableTextAreaComponent`
...
```tsx
import { createNullableTextAreaComponent } from "react-native-app-helpers";

const ExampleInput = createNullableTextAreaComponent(
    {
