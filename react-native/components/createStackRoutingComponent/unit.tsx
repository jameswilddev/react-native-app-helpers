...
test(`can render one item width fills container height fills container`, () => {
  type ParametersA = {
...
test(`can render two items width fills container height fills container`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
...
test(`can render three items width fills container height fills container`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
...
test(`can render one item width fits content height fills container`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
...
test(`can render two items width fits content height fills container`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
  ...
  expect(unwrapRenderedFunctionComponent(rendered)).toEqual(
    <React.Fragment>
      <View key="0" style={{ height: `100%`, display: `none` }}>
        <RouteB
          push={expect.any(Function)}
          pop={expect.any(Function)}
          replace={expect.any(Function)}
...
test(`can render three items width fits content height fills container`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
  ...
  expect(unwrapRenderedFunctionComponent(rendered)).toEqual(
    <React.Fragment>
      ...
      <View key="1" style={{ height: `100%`, display: `none` }}>
        <RouteA
          push={expect.any(Function)}
          pop={expect.any(Function)}
          replace={expect.any(Function)}
...
test(`can render two items width fills container height fits content`, () => {
  ...
  expect(unwrapRenderedFunctionComponent(rendered)).toEqual(
    <React.Fragment>
      <View key="0" style={{ width: `100%`, display: `none` }}>
        <RouteB
          push={expect.any(Function)}
          pop={expect.any(Function)}
          replace={expect.any(Function)}
...
test(`can render three items width fills container height fits content`, () => {
  ...
  expect(unwrapRenderedFunctionComponent(rendered)).toEqual(
    <React.Fragment>
      ...
      <View key="1" style={{ width: `100%`, display: `none` }}>
        <RouteA
          push={expect.any(Function)}
          pop={expect.any(Function)}
          replace={expect.any(Function)}
...
test(`can render one item width fits content height fits content`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
...
test(`can render two items width fits content height fits content`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
...
test(`can render three items width fits content height fits content`, () => {
  type ParametersA = {
    readonly testRouteAParameterKey:
      | `Test Route A Parameter Value A`
      | `Test Route A Parameter Value B`;
