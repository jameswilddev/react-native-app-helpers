# `react-native-app-helpers/createNullableIntegerInputComponent`
...
```tsx
import { createNullableIntegerInputComponent } from "react-native-app-helpers";

const ExampleInput = createNullableIntegerInputComponent(
    {
