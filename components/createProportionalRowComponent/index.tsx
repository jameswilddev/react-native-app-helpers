 ...
 */
export function createProportionalRowComponent<T extends ReadonlyArray<never>>(
  spacing: number,
  ...
  const viewStyles: { readonly view: ViewStyle }[] = [];
  ...
  return ({ height, verticalAlignment, children }) => {
    const intercalatedChildren: (null | JSX.Element)[] = [];
